...
ApplicationWindow{
    ...
    onShowImage: {      //显示专辑封面
        ...
        dialogs.songLabelDialog.picImage.source = ""
        if(dialogs.songLabelDialog.song.flag){
            rootImage.source = "../resource/image/pic.png"
            content.leftImage.source = "../resource/image/pic.png"
            dialogs.songLabelDialog.picImage.source = "../resource/image/pic.png"
        }else{
            rootImage.source = "../resource/image/背景3.png"
            content.leftImage.source = "../resource/image/背景3.png"
        }
    }
