...
class Lyric: public QObject
{
    ...
    Q_PROPERTY(QList<QString> painLyric READ painLyric WRITE setPainLyric NOTIFY painLyricChanged)
...
public slots:
    ...
    void setPainLyric(QList<QString> painLyric)
    {
        if (m_painLyric == painLyric)
            return;

        m_painLyric = painLyric;
        emit painLyricChanged(m_painLyric);
    }
...
signals:
    ...
    void painLyricChanged(QList<QString> painLyric);
